...
def load_arguments(self, _):
    ...
    with self.argument_context('datashare dataset list') as c:
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('datashare dataset show') as c:
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('datashare dataset create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the share account.')
    ...
    with self.argument_context('datashare dataset delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the share account.', id_part='name')
        c.argument('share_name', type=str, help='The name of the share.', id_part='child_name_1')
        c.argument('data_set_name', options_list=['--name', '-n', '--data-set-name'], type=str, help='The name of the '
    ...
    with self.argument_context('datashare synchronization list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('account_name', type=str, help='The name of the share account.', id_part='name')
    ...
    with self.argument_context('datashare synchronization list-detail') as c:
        ...
        c.argument('id_', options_list=['--id'], type=str, help='Synchronization id')
    ...
    with self.argument_context('datashare consumer share-subscription synchronization list') as c:
        ...
        c.argument('share_subscription_name', options_list=['--name', '-n', '--share-subscription-name'], type=str,
                   help='The name of the share subscription.', id_part='child_name_1')
        c.argument('skip_token', type=str, help='Continuation token')
        c.argument('filter_', options_list=['--filter'], type=str, help='Filters the results using OData syntax.')
        c.argument('orderby', type=str, help='Sorts the results using OData syntax.')
    ...
    with self.argument_context('datashare consumer share-subscription synchronization start') as c:
        ...
        c.argument('mode', arg_type=get_enum_type(['Incremental', 'FullSync']), help='Mode of synchronization used in '
                   'triggers and snapshot sync. Incremental by default')
