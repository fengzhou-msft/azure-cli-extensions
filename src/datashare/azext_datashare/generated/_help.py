...
helps['datashare consumer invitation reject'] = """
    ...
    examples:
      - name: ConsumerInvitations_RejectInvitation
        text: |-
               az datashare consumer invitation reject --invitation-id "dfbbc788-19eb-4607-a5a1-c74181bfff03" \
--location "East US 2"
"""
...
helps['datashare dataset list'] = """
    ...
    examples:
      - name: DataSets_ListByShare
        text: |-
               az datashare dataset list --account-name "Account1" --resource-group "SampleResourceGroup" --share-name \
"Share1"
"""
...
helps['datashare dataset show'] = """
    ...
    examples:
      - name: DataSets_Get
        text: |-
               az datashare dataset show --account-name "Account1" --name "Dataset1" --resource-group \
...
table-name=XX kind=XX
    ...
    examples:
      - name: DataSets_Create
        text: |-
               az datashare dataset create --account-name "Account1" --blob-data-set container-name="C1" \
...
4e77-ad86-90acdc75eb1a" --name "Dataset1" --resource-group "SampleResourceGroup" --share-name "Share1"
      - name: DataSets_KustoCluster_Create
        text: |-
               az datashare dataset create --account-name "Account1" --kusto-cluster-data-set \
...
ders/Microsoft.Kusto/clusters/Cluster1" --name "Dataset1" --resource-group "SampleResourceGroup" --share-name "Share1"
      - name: DataSets_KustoDatabase_Create
        text: |-
               az datashare dataset create --account-name "Account1" --kusto-database-data-set \
...
--share-name "Share1"
      - name: DataSets_SqlDBTable_Create
        text: |-
               az datashare dataset create --account-name "Account1" --sqldb-table-data-set database-name="SqlDB1" \
...
"SampleResourceGroup" --share-name "Share1"
      - name: DataSets_SqlDWTable_Create
        text: |-
               az datashare dataset create --account-name "Account1" --sqldw-table-data-set \
...
helps['datashare dataset delete'] = """
    ...
    examples:
      - name: DataSets_Delete
        text: |-
               az datashare dataset delete --account-name "Account1" --name "Dataset1" --resource-group \
"SampleResourceGroup" --share-name "Share1"
"""
...
helps['datashare dataset wait'] = """
    ...
    examples:
      - name: Pause executing next line of CLI script until the datashare dataset is successfully deleted.
        text: |-
               az datashare dataset wait --account-name "Account1" --name "Dataset1" --resource-group \
...
helps['datashare consumer dataset-mapping list'] = """
    ...
    examples:
      - name: DataSetMappings_ListByShareSubscription
        text: |-
               az datashare consumer dataset-mapping list --account-name "Account1" --resource-group \
...
sql-server-resource-id=XX table-name=XX kind=XX
    ...
    examples:
      - name: DataSetMappings_Create
        text: |-
               az datashare consumer dataset-mapping create --account-name "Account1" --blob-data-set-mapping \
...
helps['datashare synchronization'] = """
    type: group
    short-summary: Manage share with datashare sub group synchronization
"""
...
helps['datashare synchronization list'] = """
    ...
    examples:
      - name: Shares_ListSynchronizations
        text: |-
               az datashare synchronization list --account-name "Account1" --resource-group "SampleResourceGroup" \
--name "Share1"
"""
...
helps['datashare synchronization list-detail'] = """
    ...
    examples:
      - name: Shares_ListSynchronizationDetails
        text: |-
               az datashare synchronization list-detail --account-name "Account1" --resource-group \
"SampleResourceGroup" --name "Share1" --id "7d0536a6-3fa5-43de-b152-3d07c4f6b2bb"
"""
...
helps['datashare consumer share-subscription list'] = """
    ...
    examples:
      - name: ShareSubscriptions_ListByAccount
        text: |-
               az datashare consumer share-subscription list --account-name "Account1" --resource-group \
"SampleResourceGroup"
"""

helps['datashare consumer share-subscription synchronization'] = """
    type: group
    short-summary: Manage share subscription with datashare sub group synchronization
"""
...
helps['datashare consumer share-subscription show'] = """
    ...
    examples:
      - name: ShareSubscriptions_Get
        text: |-
               az datashare consumer share-subscription show --account-name "Account1" --resource-group \
"SampleResourceGroup" --name "ShareSubscription1"
"""
...
helps['datashare consumer share-subscription create'] = """
    ...
    examples:
      - name: ShareSubscriptions_Create
        text: |-
               az datashare consumer share-subscription create --account-name "Account1" --resource-group \
"SampleResourceGroup" --invitation-id "12345678-1234-1234-12345678abd" --source-share-location "eastus2" --name \
"ShareSubscription1"
"""
...
helps['datashare consumer share-subscription delete'] = """
    ...
    examples:
      - name: ShareSubscriptions_Delete
        text: |-
               az datashare consumer share-subscription delete --account-name "Account1" --resource-group \
"SampleResourceGroup" --name "ShareSubscription1"
"""
...
"Account1" --resource-group "SampleResourceGroup" --name "ShareSub1"
"""
...
helps['datashare consumer share-subscription wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the datashare consumer share-subscription is \
met.
    examples:
      - name: Pause executing next line of CLI script until the datashare consumer share-subscription is successfully \
deleted.
        text: |-
               az datashare consumer share-subscription wait --account-name "Account1" --resource-group \
"SampleResourceGroup" --name "ShareSubscription1" --deleted
      - name: Pause executing next line of CLI script until the datashare consumer share-subscription is successfully \
created.
        text: |-
               az datashare consumer share-subscription wait --account-name "Account1" --resource-group \
"SampleResourceGroup" --name "ShareSubscription1" --created
"""
...
helps['datashare consumer trigger wait'] = """
    type: command
    short-summary: Place the CLI in a waiting state until a condition of the datashare consumer trigger is met.
    examples:
      - name: Pause executing next line of CLI script until the datashare consumer trigger is successfully created.
        text: |-
               az datashare consumer trigger wait --account-name "Account1" --resource-group "SampleResourceGroup" \
--share-subscription-name "ShareSubscription1" --name "Trigger1" --created
      - name: Pause executing next line of CLI script until the datashare consumer trigger is successfully deleted.
        text: |-
               az datashare consumer trigger wait --account-name "Account1" --resource-group "SampleResourceGroup" \
