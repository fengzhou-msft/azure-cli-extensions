...
def load_command_table(self, _):
    ...
    datashare_consumer_invitation = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._consumer_invitation_operations#ConsumerInv'
        'itationOperations.{}',
    ...
    datashare_data_set_mapping = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._data_set_mapping_operations#DataSetMapping'
        'Operations.{}',
    ...
    datashare_provider_share_subscription = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._provider_share_subscription_operations#Pro'
        'viderShareSubscriptionOperations.{}',
    ...
    datashare_share_subscription = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._share_subscription_operations#ShareSubscri'
        'ptionOperations.{}',
    ...
    datashare_consumer_source_data_set = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._consumer_source_data_set_operations#Consum'
        'erSourceDataSetOperations.{}',
    ...
    datashare_synchronization_setting = CliCommandType(
        operations_tmpl='azext_datashare.vendored_sdks.datashare.operations._synchronization_setting_operations#Synchro'
        'nizationSettingOperations.{}',
