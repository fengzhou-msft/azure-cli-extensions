...
def load_command_table(self, _):
    ...
    with self.command_group('datashare account', datashare_account, client_factory=cf_account,
    ...
    with self.command_group('datashare data-set', datashare_data_set, client_factory=cf_data_set,
                            is_experimental=True) as g:
    ...
    with self.command_group('datashare consumer dataset-mapping', datashare_data_set_mapping,
        ...
        g.custom_command('delete', 'datashare_consumer_dataset_mapping_delete')
    ...
    with self.command_group('datashare', datashare_share, client_factory=cf_share) as g:
        ...
        g.custom_command('delete', 'datashare_delete', supports_no_wait=True)
    ...
    with self.command_group('datashare provider-share-subscription', datashare_provider_share_subscription,
                            client_factory=cf_provider_share_subscription, is_experimental=True) as g:
    ...
    with self.command_group('datashare-subscription', datashare_share_subscription,
                            client_factory=cf_share_subscription) as g:
        g.custom_command('list', 'datashare_subscription_list')
        g.custom_show_command('show', 'datashare_subscription_show')
        g.custom_command('create', 'datashare_subscription_create')
        g.custom_command('delete', 'datashare_subscription_delete', supports_no_wait=True)
        g.custom_command('cancel-synchronization', 'datashare_subscription_cancel_synchronization',
                         supports_no_wait=True)
        g.custom_command('list-source-share-synchronization-setting', 'datashare_subscription_list_source_share_synchro'
                         'nization_setting')
        g.custom_command('list-synchronization', 'datashare_subscription_list_synchronization')
        g.custom_command('list-synchronization-detail', 'datashare_subscription_list_synchronization_detail')
        g.custom_command('synchronize', 'datashare_subscription_synchronize', supports_no_wait=True)
        g.wait_command('wait')
    ...
    with self.command_group('datashare consumer share-subscription list-source-dataset',
                            datashare_consumer_source_data_set, client_factory=cf_consumer_source_data_set) as g:
        g.custom_command('list', 'datashare_consumer_share_subscription_list_source_dataset_list')
    ...
    with self.command_group('datashare synchronization-setting', datashare_synchronization_setting,
                            client_factory=cf_synchronization_setting, is_experimental=True) as g:
    ...
    with self.command_group('datashare consumer trigger', datashare_trigger, client_factory=cf_trigger) as g:
        ...
        g.custom_command('delete', 'datashare_consumer_trigger_delete', supports_no_wait=True)
        g.wait_command('wait')
