...
def datashare_consumer_dataset_mapping_list(cmd, client,
                                            resource_group_name,
                                            account_name,
...
def datashare_consumer_dataset_mapping_show(cmd, client,
                                            resource_group_name,
                                            account_name,
                                            share_subscription_name,
...
def datashare_consumer_dataset_mapping_create(cmd, client,
                                              resource_group_name,
                                              account_name,
                                              share_subscription_name,
                                              data_set_mapping_name,
...
def datashare_consumer_dataset_mapping_delete(cmd, client,
                                              resource_group_name,
                                              account_name,
                                              share_subscription_name,
                                              data_set_mapping_name):
...
def datashare_create(cmd, client,
                     resource_group_name,
                     account_name,
                     share_name,
                     description=None,
...
def datashare_delete(cmd, client,
                     resource_group_name,
                     account_name,
                     share_name):
    return client.begin_delete(resource_group_name=resource_group_name,
...
def datashare_list_synchronization(cmd, client,
                                   resource_group_name,
                                   account_name,
                                   share_name,
                                   skip_token=None):
...
def datashare_list_synchronization_detail(cmd, client,
                                          resource_group_name,
                                          account_name,
                                          share_name,
                                          skip_token=None,
...
def datashare_subscription_list(cmd, client,
                                resource_group_name,
                                account_name,
                                skip_token=None):
    return client.list_by_account(resource_group_name=resource_group_name,
...
def datashare_subscription_show(cmd, client,
                                resource_group_name,
                                account_name,
                                share_subscription_name):
    return client.get(resource_group_name=resource_group_name,
...
def datashare_subscription_create(cmd, client,
                                  resource_group_name,
                                  account_name,
                                  share_subscription_name,
                                  invitation_id,
...
def datashare_subscription_delete(cmd, client,
                                  resource_group_name,
                                  account_name,
                                  share_subscription_name):
    return client.begin_delete(resource_group_name=resource_group_name,
...
def datashare_subscription_cancel_synchronization(cmd, client,
                                                  resource_group_name,
                                                  account_name,
                                                  share_subscription_name,
                                                  synchronization_id):
...
def datashare_subscription_list_source_share_synchronization_setting(cmd, client,
                                                                     resource_group_name,
                                                                     account_name,
                                                                     share_subscription_name,
                                                                     skip_token=None):
...
def datashare_subscription_list_synchronization(cmd, client,
                                                resource_group_name,
                                                account_name,
                                                share_subscription_name,
                                                skip_token=None):
...
def datashare_subscription_list_synchronization_detail(cmd, client,
                                                       resource_group_name,
                                                       account_name,
                                                       share_subscription_name,
                                                       synchronization_id,
...
def datashare_subscription_synchronize(cmd, client,
                                       resource_group_name,
                                       account_name,
                                       share_subscription_name,
...
def datashare_consumer_share_subscription_list_source_dataset_list(cmd, client,
                                                                   resource_group_name,
                                                                   account_name,
                                                                   share_subscription_name,
                                                                   skip_token=None):
...
def datashare_consumer_trigger_list(cmd, client,
                                    resource_group_name,
                                    account_name,
                                    share_subscription_name,
                                    skip_token=None):
...
def datashare_consumer_trigger_show(cmd, client,
                                    resource_group_name,
                                    account_name,
                                    share_subscription_name,
                                    trigger_name):
...
def datashare_consumer_trigger_create(cmd, client,
                                      resource_group_name,
                                      account_name,
                                      share_subscription_name,
                                      trigger_name,
...
def datashare_consumer_trigger_delete(cmd, client,
                                      resource_group_name,
                                      account_name,
                                      share_subscription_name,
                                      trigger_name):
