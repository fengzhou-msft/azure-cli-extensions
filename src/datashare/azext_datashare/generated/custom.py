...
def datashare_consumer_invitation_list(client,
                                       skip_token=None):
...
def datashare_consumer_invitation_reject(client,
                                         location,
                                         invitation_id):
    invitation = {}
...
def datashare_dataset_list(client,
                           resource_group_name,
                           account_name,
                           share_name,
                           skip_token=None,
...
def datashare_dataset_show(client,
                           resource_group_name,
                           account_name,
                           share_name,
                           data_set_name):
...
def datashare_dataset_create(client,
                             resource_group_name,
                             account_name,
                             share_name,
                             data_set_name,
    ...
    if len(all_data_set) > 1:
        raise CLIError('at most one of  adls_gen1_file_data_set, adls_gen1_folder_data_set, adls_gen2_file_data_set, '
                       ...
                       'sqldb_table_data_set, sqldw_table_data_set is needed for data_set!')
    if len(all_data_set) != 1:
        raise CLIError('data_set is required. but none of adls_gen1_file_data_set, adls_gen1_folder_data_set, '
                       ...
                       'kusto_database_data_set, sqldb_table_data_set, sqldw_table_data_set is provided!')
...
def datashare_dataset_delete(client,
                             resource_group_name,
                             account_name,
                             share_name,
                             data_set_name,
...
def datashare_consumer_dataset_mapping_list(client,
                                            resource_group_name,
                                            account_name,
...
def datashare_consumer_dataset_mapping_show(client,
                                            resource_group_name,
                                            account_name,
                                            share_subscription_name,
...
def datashare_consumer_dataset_mapping_create(client,
                                              resource_group_name,
                                              account_name,
                                              share_subscription_name,
                                              data_set_mapping_name,
    ...
    if len(all_data_set_mapping) > 1:
        raise CLIError('at most one of  adls_gen2_file_data_set_mapping, adls_gen2_file_system_data_set_mapping, '
                       ...
                       'sqldb_table_data_set_mapping, sqldw_table_data_set_mapping is needed for data_set_mapping!')
    if len(all_data_set_mapping) != 1:
        raise CLIError('data_set_mapping is required. but none of adls_gen2_file_data_set_mapping, '
                       ...
                       'sqldw_table_data_set_mapping is provided!')
...
def datashare_consumer_dataset_mapping_delete(client,
                                              resource_group_name,
                                              account_name,
                                              share_subscription_name,
                                              data_set_mapping_name):
...
def datashare_synchronization_list(client,
                                   resource_group_name,
                                   account_name,
                                   share_name,
                                   skip_token=None,
...
def datashare_synchronization_list_detail(client,
                                          resource_group_name,
                                          account_name,
                                          share_name,
                                          skip_token=None,
    ...
    share_synchronization['synchronization_id'] = id_
...
def datashare_consumer_share_subscription_list(client,
                                               resource_group_name,
                                               account_name,
                                               skip_token=None,
                                               filter_=None,
...
def datashare_consumer_share_subscription_synchronization_list(client,
                                                               resource_group_name,
                                                               account_name,
                                                               share_subscription_name,
                                                               skip_token=None,
...
def datashare_consumer_share_subscription_show(client,
                                               resource_group_name,
                                               account_name,
                                               share_subscription_name):
    return client.get(resource_group_name=resource_group_name,
...
def datashare_consumer_share_subscription_create(client,
                                                 resource_group_name,
                                                 account_name,
                                                 share_subscription_name,
                                                 invitation_id,
...
def datashare_consumer_share_subscription_delete(client,
                                                 resource_group_name,
                                                 account_name,
                                                 share_subscription_name,
                                                 no_wait=False):
...
def datashare_consumer_share_subscription_list_source_dataset(client,
                                                              resource_group_name,
                                                              account_name,
                                                              share_subscription_name,
                                                              skip_token=None):
...
def datashare_consumer_share_subscription_list_source_share_synchronization_setting(client,
                                                                                    resource_group_name,
                                                                                    account_name,
                                                                                    share_subscription_name,
                                                                                    skip_token=None):
...
def datashare_consumer_share_subscription_synchronization_cancel(client,
                                                                 resource_group_name,
                                                                 account_name,
                                                                 share_subscription_name,
                                                                 id_,
    ...
    share_subscription_synchronization['synchronization_id'] = id_
    return sdk_no_wait(no_wait,
...
def datashare_consumer_share_subscription_synchronization_list_detail(client,
                                                                      resource_group_name,
                                                                      account_name,
                                                                      share_subscription_name,
                                                                      id_,
...
def datashare_consumer_share_subscription_synchronization_start(client,
                                                                resource_group_name,
                                                                account_name,
                                                                share_subscription_name,
                                                                mode=None,
                                                                no_wait=False):
    synchronize = {}
    synchronize['synchronization_mode'] = mode
    return sdk_no_wait(no_wait,
...
def datashare_consumer_trigger_list(client,
                                    resource_group_name,
                                    account_name,
                                    share_subscription_name,
                                    skip_token=None):
...
def datashare_consumer_trigger_show(client,
                                    resource_group_name,
                                    account_name,
                                    share_subscription_name,
                                    trigger_name):
...
def datashare_consumer_trigger_create(client,
                                      resource_group_name,
                                      account_name,
                                      share_subscription_name,
                                      trigger_name,
...
def datashare_consumer_trigger_delete(client,
                                      resource_group_name,
                                      account_name,
                                      share_subscription_name,
                                      trigger_name,
