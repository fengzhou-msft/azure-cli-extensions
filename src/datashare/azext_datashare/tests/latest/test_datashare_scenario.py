...
class DataShareManagementClientScenarioTest(ScenarioTest):
    ...
    def test_datashare(self, resource_group):
        ...
        self.cmd('az datashare data-set create '
                 ...
                 '"file21\\",\\"resourceGroup\\":\\"SampleResourceGroup\\",\\"storageAccountName\\":\\"storage2\\",\\"s'
                 'ubscriptionId\\":\\"433a8dfd-e5d5-4e77-ad86-90acdc75eb1a\\"}}}}" '
                 '--data-set-name "{Dataset1}" '
                 '--resource-group "{rg}" '
                 '--share-name "{Share1}"',
                 checks=[])
        ...
        self.cmd('az datashare consumer-invitation list-invitation',
                 checks=[])
