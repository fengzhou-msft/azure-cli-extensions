...
create a datashare consumer dataset-mapping.
...
|**--adls-gen2-folder-data-set-mapping**|object|An ADLS Gen2 folder data set mapping.|adls_gen2_folder_data_set_mapping|
...
delete a datashare consumer dataset-mapping.
...
list a datashare consumer dataset-mapping.
...
show a datashare consumer dataset-mapping.
...
### datashare consumer share-subscription list-source-dataset list

list a datashare consumer share-subscription list-source-dataset.
...
create a datashare consumer trigger.
...
delete a datashare consumer trigger.
...
list a datashare consumer trigger.
...
show a datashare consumer trigger.
...
|**--account-name**|string|The name of the share account.|account_name|
|**--skip-token**|string|Continuation Token|skip_token|
### datashare list-synchronization

list-synchronization a datashare.
...
|**--share-name**|string|The name of the share.|share_name|
|**--skip-token**|string|Continuation token|skip_token|
### datashare list-synchronization-detail

list-synchronization-detail a datashare.
...
|**--share-name**|string|The name of the share.|share_name|
|**--synchronization-setting-name**|string|The name of the synchronizationSetting.|synchronization_setting_name|
### datashare-subscription cancel-synchronization

cancel-synchronization a datashare-subscription.
...
|**--share-subscription-name**|string|The name of the shareSubscription.|share_subscription_name|
|**--synchronization-id**|string|Synchronization id|synchronization_id|
### datashare-subscription create

create a datashare-subscription.
...
### datashare-subscription delete

delete a datashare-subscription.
...
|**--account-name**|string|The name of the share account.|account_name|
|**--share-subscription-name**|string|The name of the shareSubscription.|share_subscription_name|
### datashare-subscription list

list a datashare-subscription.
...
|**--account-name**|string|The name of the share account.|account_name|
|**--skip-token**|string|Continuation Token|skip_token|
### datashare-subscription list-source-share-synchronization-setting

list-source-share-synchronization-setting a datashare-subscription.
...
|**--share-subscription-name**|string|The name of the shareSubscription.|share_subscription_name|
|**--skip-token**|string|Continuation token|skip_token|
### datashare-subscription list-synchronization

list-synchronization a datashare-subscription.
...
|**--share-subscription-name**|string|The name of the share subscription.|share_subscription_name|
|**--skip-token**|string|Continuation token|skip_token|
### datashare-subscription list-synchronization-detail

list-synchronization-detail a datashare-subscription.
...
|**--synchronization-id**|string|Synchronization id|synchronization_id|
|**--skip-token**|string|Continuation token|skip_token|
### datashare-subscription show

show a datashare-subscription.
...
|**--account-name**|string|The name of the share account.|account_name|
|**--share-subscription-name**|string|The name of the shareSubscription.|share_subscription_name|
### datashare-subscription synchronize

synchronize a datashare-subscription.
