...
# EXAMPLE: /Subscriptions/post/cancelSubscription
@try_manual
def step__subscriptions_post_cancelsubscription(test):
    test.cmd('az account subscription cancel '
             '--subscription-id "83aa47df-e3e9-49ff-877b-94304bf3d3ad"',
             checks=[])


# EXAMPLE: /Subscriptions/post/enableSubscription
@try_manual
def step__subscriptions_post_enablesubscription(test):
    test.cmd('az account subscription enable '
             '--subscription-id "7948bcee-488c-47ce-941c-38e20ede803d"',
             checks=[])


# EXAMPLE: /Subscriptions/post/renameSubscription
@try_manual
def step__subscriptions_post_renamesubscription(test):
...
def call_scenario(test):
    ...
    step__subscriptions_post_cancelsubscription(test)
    step__subscriptions_post_enablesubscription(test)
    step__subscriptions_post_renamesubscription(test)
