...
def load_command_table(self, _):
    ...
    with self.command_group('datadog term', datadog_marketplace_agreement,
                            client_factory=cf_marketplace_agreement) as g:
        g.custom_command('list', 'datadog_term_list')

    from azext_datadog.generated._client_factory import cf_api_key
    datadog_api_key = CliCommandType(
        operations_tmpl='azext_datadog.vendored_sdks.datadog.operations._api_keys_operations#ApiKeysOperations.{}',
        client_factory=cf_api_key)
    with self.command_group('datadog api-key', datadog_api_key, client_factory=cf_api_key) as g:
    ...
    datadog_host = CliCommandType(
        operations_tmpl='azext_datadog.vendored_sdks.datadog.operations._hosts_operations#HostsOperations.{}',
        client_factory=cf_host)
    with self.command_group('datadog host', datadog_host, client_factory=cf_host) as g:
    ...
    datadog_linked_resource = CliCommandType(
        operations_tmpl='azext_datadog.vendored_sdks.datadog.operations._linked_resources_operations#LinkedResourcesOpe'
        'rations.{}',
        client_factory=cf_linked_resource)
    with self.command_group('datadog linked-resource', datadog_linked_resource,
                            client_factory=cf_linked_resource) as g:
    ...
    datadog_monitored_resource = CliCommandType(
        operations_tmpl='azext_datadog.vendored_sdks.datadog.operations._monitored_resources_operations#MonitoredResour'
        'cesOperations.{}',
    ...
    with self.command_group('datadog set-password-link', datadog_refresh_set_password,
                            client_factory=cf_refresh_set_password) as g:
